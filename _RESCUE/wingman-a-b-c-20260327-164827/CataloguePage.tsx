...
function _addSkuToProject(sku: string) {
...
function _addBomQty(sku: string) {
  if (!activeProject) return;
...
function _reduceBomQty(sku: string) {
  if (!activeProject) return;
...
function _removeSkuFromProject(sku: string) {
  if (!activeProject) return;
...
const filteredProducts = React.useMemo(() => {
...
}, [activeProject?.discovery?.recommendedFamilies, catalogueProducts]);
  ...
  return (
    ...
    <div className="wm-page wm-catalog-page wm-catalog-page wm-catalog-page wm-cat2" data-page="catalogue">
