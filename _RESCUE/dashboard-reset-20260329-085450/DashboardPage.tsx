...
export default function DashboardPage() {
  ...
  const quickTools: QuickTool[] = [
    { title: "Video Wall Planner", route: "/app/tools/video-wall", icon: "Ã°Å¸â€“Â¥Ã¯Â¸Â" },
    { title: "Catalogue", route: "/app/tools/catalog", icon: "Ã°Å¸â€œÅ¡" },
    { title: "Templates", route: "/app/tools/templates", icon: "Ã°Å¸Â§Â©" },
    { title: "Import Intake", route: "/app/tools/import-intake", icon: "Ã¢Â¬â€ Ã¯Â¸Â" },
  ];
    ...
    <main className="wm-dashboard-page" style={pageStyle}>
      ...
      <section style={contextBarStyle}>
        ...
        <div style={contextBlockStyle}>
          ...
          <div style={workflowLineStyle}>Discovery Ã¢â€ â€™ Design Ã¢â€ â€™ Proposal</div>
        </div>
        ...
        <aside style={rightColumnStyle}>
          ...
          <section style={guruPanelStyle}>
            ...
            <div style={stack6MinWidthStyle}>
              <div style={guruPanelTitleStyle}>/div>
      ...
      >
        ...
        <div className="wm-guru__text">
          <div className="wm-guru__eyebrow">/div>
