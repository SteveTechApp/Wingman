...
const defaultUiText: WingmanUiText = {
...
const translatedUiText: Partial<Record<WingmanLanguageId, WingmanUiText>> = {
  "es-ES": {
    goodMorning: "Buenos dias, Wingman",
    newProject: "Nuevo proyecto",
    overallLanguage: "Region Wingman",
    captureLanguage: "Idioma de captura",
    languageSettings: "Region y captura",
  },
  "fr-FR": {
    goodMorning: "Bonjour, Wingman",
    newProject: "Nouveau projet",
    overallLanguage: "Region Wingman",
    captureLanguage: "Langue de capture",
    languageSettings: "Region et capture",
  },
  "de-DE": {
    goodMorning: "Guten Morgen, Wingman",
    newProject: "Neues Projekt",
    overallLanguage: "Wingman-Region",
    captureLanguage: "Erfassungssprache",
    languageSettings: "Region und Erfassung",
  },
  "it-IT": {
    goodMorning: "Buongiorno, Wingman",
    newProject: "Nuovo progetto",
    overallLanguage: "Regione Wingman",
    captureLanguage: "Lingua di acquisizione",
    languageSettings: "Regione e acquisizione",
  },
  "nl-NL": {
    goodMorning: "Goedemorgen, Wingman",
    newProject: "Nieuw project",
    overallLanguage: "Wingman-regio",
    captureLanguage: "Opnametaal",
    languageSettings: "Regio en opname",
  },
  "pt-PT": {
    goodMorning: "Bom dia, Wingman",
    newProject: "Novo projeto",
    overallLanguage: "Regiao Wingman",
    captureLanguage: "Idioma de captura",
    languageSettings: "Regiao e captura",
  },
  "zh-CN": {
    goodMorning: "Ni hao, Wingman",
    newProject: "New Project",
    overallLanguage: "Wingman region",
    captureLanguage: "Capture language",
    languageSettings: "Region and capture settings",
...
export function getWingmanUiText(id?: WingmanLanguageId) {
  if (id && translatedUiText[id]) {
    return translatedUiText[id] ?? defaultUiText;
  }
...
export function useWingmanLanguage() {
  ...
  const currentUiText = useMemo(() => getWingmanUiText(languageId), [languageId]);
