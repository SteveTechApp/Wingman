...
import {
  ...
  setActiveProject,
  subscribeProjects,
} from "@/state/app/app/app/app/app/app/app/app/projectsStore";
        ...
        <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
          ...
          <button
            ...
            onClick={() => {
              ...
              setName("");
              nav("/app/app/app/app/app/app/app/app/projects/" + p.id);
            }}
            style={{
              height: 34,
              padding: "0 12px",
                ...
                <div style={{ display: "grid", gap: 6 }}>
                  ...
                  <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
                    ...
                    <button
                      ...
                      onClick={() => {
                        setActiveProject(p.id);
                        nav("/app/app/app/app/app/app/app/app/dashboard");
                      }}
                      style={{
                        height: 30,
                        padding: "0 10px",
