...
import { getActiveProject, subscribeProjects } from "@/state/app/app/app/app/app/app/app/app/projectsStore";
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(2, minmax(0, 1fr))", gap: 10 }}>
        <div style={{ padding: 12, borderRadius: 14, border: "1px solid rgba(255,255,255,0.12)", background: "rgba(255,255,255,0.03)" }}>
          ...
          <div style={{ display: "flex", gap: 8, marginTop: 10, flexWrap: "wrap" }}>
            ...
            <button
              type="button"
              onClick={() => nav("/app/app/app/app/app/app/app/app/projects")}
              style={{
                height: 30,
                padding: "0 10px",
                borderRadius: 10,
