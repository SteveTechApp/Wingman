...
export default function DashboardPage() {
  return (
    <PageFrame
      ...
      actions={
        <>
          <Link to="/app/projects"><button className="wm-btn-secondary">Projects</button></Link>
          <Link to="/app/projects/new"><button className="wm-btn-primary">+ Start New Project</button></Link>
        </>
      }
      aside={
        ...
        <div className="wm-hero">
          <div className="wm-heroCard">
            ...
            <div className="wm-buttonRow">
              <Link to="/app/projects/new"><button className="wm-btn-primary">Start Blank Project</button></Link>
              <Link to="/app/projects"><button className="wm-btn-secondary">Open Saved Projects</button></Link>
            </div>
          </div>
          ...
          <div className="wm-heroCard">
            ...
            <p>
              Capture the room, sources, displays, distances, control needs, and budget band before
              selecting architecture or recommending products.
            </p>
            <div className="wm-buttonRow">
              <Link to="/app/tools/discovery"><button className="wm-btn-primary">Continue Discovery</button></Link>
            </div>
          </div>
        </div>
      </PageSection>
