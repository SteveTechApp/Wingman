      ...
      <main className="wm-login-page__root">
        <section className="wm-login-page__card">
          ...
          <div className="wm-login-page__footer">
            <button type="button" className="wm-login-page__nav" onClick={goHome}>
              Back to site
            </button>
            <button type="button" className="wm-login-page__nav" onClick={goSignup}>
              Create account
            </button>
          </div>
        </section>
      ...
      <main className="wm-signup-page__root">
        <section className="wm-signup-page__card">
          ...
          <div className="wm-signup-page__footer">
            <button type="button" className="wm-signup-page__nav" onClick={goHome}>
              Back to site
            </button>
            <button type="button" className="wm-signup-page__nav" onClick={goLogin}>
        ...
        <section className="wm-public-landing-page__shell">
          <article className="wm-public-landing-page__panel wm-public-landing-page__panel--left">
            ...
            <div className="wm-public-landing-page__actions">
              <button type="button" className="wm-public-landing-page__btn wm-public-landing-page__btn--primary" onClick={goLogin}>
                Sign in
              </button>
              <button type="button" className="wm-public-landing-page__btn wm-public-landing-page__btn--secondary" onClick={goSignup}>
                Create account
              </button>
            </div>
...
Write-Host "Public/auth navigation pass v2 applied."
Write-Host "Run:"
