...
$rescue = Join-Path $repo "_RESCUE\LandingLogoRestore_$stamp"
...
Write-Host ""
Write-Host "== Landing page logo restored ==" -ForegroundColor Cyan
Write-Host "Repo:   $repo"
Write-Host "File:   $pagePath"
Write-Host "Backup: $rescue"
Write-Host ""
Write-Host "What changed:"
Write-Host " - Added /heroLogo.png back into the landing hero"
Write-Host " - Keeps the simplified landing layout"
Write-Host " - Restores stronger Wingman branding above the headline"
Write-Host ""
Write-Host "Next:"
