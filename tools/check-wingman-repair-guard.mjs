...
function fail(message) {
  console.error(`[wingman-repair-guard] ${message}`);
  process.exit(1);
}
...
console.log(`[wingman-repair-guard] CSS size ${cssMb.toFixed(2)} MB`);
console.log("[wingman-repair-guard] Repair guard passed.");