...
mustContain("src/wingman2/styles/wingman-style-stack.css", "PRODUCT-FINDER-SURFACE-HIERARCHY-START", "Finder surface hierarchy CSS");
mustContain("src/wingman2/styles/wingman-style-stack.css", "DISCOVERY-APPLICATION-STEP-RESTORE-START", "Discovery Application restore CSS");
