...
async function callGuru(message: string): Promise<string> {
  try {
    ...
    return "Guru is not connected yet. Use /import to paste RFQ/tender text and extract requirements. If asking WyreStorm: include endpoint count, distances, USB-C/BYOD, and 4K/4K60.";
  }
}
