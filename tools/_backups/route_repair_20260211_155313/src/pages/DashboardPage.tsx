...
export default function DashboardPage() {
  ...
  const design: Tile[] = [
    { title: "Room Wizard", desc: "Design AV rooms quickly with guided inputs.", to: "/tools/room", tag: "Design" },
    { title: "Video Wall", desc: "Plan LED/LCD walls and outputs cleanly.", to: "/tools/videowall", tag: "Design" },
    { title: "Templates", desc: "Start from proven vertical templates.", to: "/tools/templates", tag: "Library" },
  ];

  const sales: Tile[] = [
    { title: "Competitor Compare", desc: "Match SKUs and position WyreStorm alternatives.", to: "/tools/competitor-compare", tag: "Sales" },
    { title: "Proposal", desc: "Generate a proposal pack from your project.", to: "/tools/proposal", tag: "Docs" },
    { title: "Compare", desc: "Compare solutions and configurations.", to: "/tools/compare", tag: "Tools" },
  ];

  const support: Tile[] = [
    { title: "Tool Hub", desc: "All tools in one place (utilities + helpers).", to: "/toolhub", tag: "Hub" },
    { title: "Training Hub", desc: "Sales + technical learning modules.", to: "/tools/training", tag: "Learn" },
    { title: "Ask Wingman", desc: "Quick questions, guidance and recommendations.", to: "/tools/ask", tag: "AI" },
  ];
