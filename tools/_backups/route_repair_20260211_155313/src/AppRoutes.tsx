  ...
  return (
    <React.Suspense fallback={<div className="p-4">Loading…</div>}>
      <Routes>
        ...
        <Route path="/app/dashboard" element={<Navigate to="/app/dashboard" replace />} />
        <Route path="/app/projects" element={<Navigate to="/app/projects" replace />} />
        <Route path="/projects/:id" element={<Navigate to="/app/projects" replace />} />
        <Route path="/app/import" element={<Navigate to="/app/import" replace />} />
        <Route path="/app/toolhub" element={<Navigate to="/app/toolhub" replace />} />

        <Route path="/app/toolhub" element={<Navigate to="/app/toolhub" replace />} />
        <Route path="/app/tools/compare" element={<Navigate to="/app/tools/compare" replace />} />
        <Route path="/app/tools/competitor-compare" element={<Navigate to="/app/tools/competitor-compare" replace />} />
        <Route path="/app/tools/analytics" element={<Navigate to="/app/tools/analytics" replace />} />
        <Route path="/app/tools/proposal" element={<Navigate to="/app/tools/proposal" replace />} />
        <Route path="/app/tools/training" element={<Navigate to="/app/tools/training" replace />} />
        <Route path="/app/tools/discovery" element={<Navigate to="/app/tools/discovery" replace />} />
        <Route path="/app/tools/guided-project" element={<Navigate to="/app/tools/guided-project" replace />} />
        <Route path="/app/tools/room" element={<Navigate to="/app/tools/room" replace />} />
        <Route path="/app/tools/videowall" element={<Navigate to="/app/tools/videowall" replace />} />
        <Route path="/app/tools/templates" element={<Navigate to="/app/tools/templates" replace />} />
        <Route path="/app/tools/ask" element={<Navigate to="/app/tools/ask" replace />} />
        <Route path="/app/tools/agent" element={<Navigate to="/app/tools/agent" replace />} />
        <Route path="/app/tools/copilot" element={<Navigate to="/app/tools/copilot" replace />} />
