...
.wm-guru-launch__hint{
  ...
  font: 500 0.82rem/1.35 "Aptos Narrow","Arial Narrow","Inter","Segoe UI"Guru"undefined") return { x: 0, y: 0 };
  ...
  return (
    <>
      ...
      {showHint ? (
        <div
          className="wm-guru-launch__hint"Guru"button"
        ...
        title="Guru"
      >
        <span className="wm-guru-launch__icon">Æ’¦¬Å“š</span>
