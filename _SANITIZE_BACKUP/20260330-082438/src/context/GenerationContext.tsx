...
function buildDesignInput(project: StoredProject) {
  ...
  return {
    ...
    discovery: {
      ...
      transportDistanceBand: valueOrFallback(discovery?.transportDistanceBand, seeds.discovery.transportDistanceBand),
      ...
      sourceTypes: valueOrFallback(discovery?.sourceTypes, seeds.discovery.sourceTypes),
      sourcePlacement: valueOrFallback(discovery?.sourcePlacement, seeds.discovery.sourcePlacement),
      sourceConnectionPath: valueOrFallback(discovery?.sourceConnectionPath, seeds.discovery.sourceConnectionPath),
      sourceConnectionType: valueOrFallback(discovery?.sourceConnectionType, seeds.discovery.sourceConnectionType),
      signalFormats: valueOrFallback(discovery?.signalFormats, seeds.discovery.signalFormats),
      signalHdr: valueOrFallback(discovery?.signalHdr, seeds.discovery.signalHdr),
      sourceCableType: valueOrFallback(discovery?.sourceCableType, seeds.discovery.sourceCableType),
      displayConnectionPath: valueOrFallback(discovery?.displayConnectionPath, seeds.discovery.displayConnectionPath),
      displayConnectionType: valueOrFallback(discovery?.displayConnectionType, seeds.discovery.displayConnectionType),
      displayCableType: valueOrFallback(discovery?.displayCableType, seeds.discovery.displayCableType),
      networkEnvironment: valueOrFallback(discovery?.networkEnvironment, seeds.discovery.networkEnvironment),
      usbNeeds: valueOrFallback(discovery?.usbNeeds, seeds.discovery.usbNeeds),
      usbStandards: valueOrFallback(discovery?.usbStandards, seeds.discovery.usbStandards),
