...
const BRAND_PATTERNS = [
  ...
  [/\b(qsc|q-?sys|core\s*(?:nano|8\s*flex|110f)|nv-?\d+)\b/i, "Q-SYS"],
  [/\b(savant|sav-)\b/i, "Savant"],
  [/\b(control4|c4-)\b/i, "Control4"],
  [/\b(cyp|pu-|clux-|au-)\b/i, "CYP"],
  [/\b(sy electronics|sy-|sy\s+electronics)\b/i, "SY Electronics"],
  [/\b(just add power|justaddpower|maxcolor|vbs-hd|vbs-hdmi)\b/i, "Just Add Power"],
  [/\b(hdanywhere|hd anywhere|mhub|xtnd)\b/i, "HDANYWHERE"],
  [/\b(turtle\s*av|tav-)\b/i, "Turtle AV"],
  [/\b(black\s*box|mcx|emerald\s+(?:pe|se|zero))\b/i, "Black Box"],
  [/\b(datapath|fx4|hx4|iqs4|wallcontrol)\b/i, "Datapath"],
  [/\b(matrox|convertip|monarch|extio)\b/i, "Matrox Video"],
