...
if ($register -notmatch 'src/main\.tsx imports only the consolidated style stack') {
    throw "CSS migration register no longer contains the single-style-stack rule. Aborting."
}
