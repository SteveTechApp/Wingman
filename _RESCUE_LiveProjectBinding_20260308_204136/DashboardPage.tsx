...
export default function DashboardPage() {
  ...
  const projectCount = getRecentProjectCount();
        ...
        >
          ...
          <div className="wm-grid-cards" style={{ gridTemplateColumns: "repeat(2, minmax(0, 1fr))" }}>
            <div className="wm-card wm-card--primary">
              ...
              <div className="wm-body" style={{ marginTop: 4 }}>{projectCount} active or recent workspace entries.</div>
            </div>
