    ...
    <WmPage>
        ...
        left={
          <WmHeroCard compact>
            <WmHeroHeader
              ...
              actions={
                <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
                  <WmButton label="Projects" onClick={() => go("/app/projects")} Icon={FolderOpen} compact />
                  <WmButton label="Dashboard" onClick={() => go("/app/dashboard")} compact />
                </div>
              }
            />
            ...
            <WmInset compact>
              ...
              >
                <WmButton label="Open Discovery" onClick={() => go("/app/tools/discovery")} Icon={Sparkles} primary full compact={compact} />
                <WmButton label="Open Catalog" onClick={() => go("/app/tools/catalog")} Icon={Package} full compact={compact} />
                <WmButton label="Open Proposal" onClick={() => go("/app/tools/proposal-builder")} Icon={FileText} full compact={compact} />
              </div>
            </WmInset>
          </WmHeroCard>
        }
        right={
          ...
          >
            <WmCard tone="primary" padding={16}>
              ...
              <WmButton label="Create Blank Project" onClick={startBlankProject} Icon={Plus} primary full compact={compact} />
            </WmCard>
            ...
            <WmCard padding={16}>
              ...
              <div style={{ display: "grid", gap: 8 }}>
                <WmButton label="1. Discovery" onClick={() => go("/app/tools/discovery")} Icon={Search} primary full compact />
                <WmButton label="2. Product Catalog" onClick={() => go("/app/tools/catalog")} Icon={Package} full compact />
                <WmButton label="3. Proposal Builder" onClick={() => go("/app/tools/proposal-builder")} Icon={FileText} full compact />
              </div>
            </WmCard>
          </div>
        }
      ...
      <WmCard padding={16}>
        <WmSectionHeader
          ...
          action={<WmTextLinkButton label="Open existing project" onClick={() => go("/app/projects")} />}
        />
        ...
        >
          {TOOLS.map((item) => (
            <WmTile
              ...
              Icon={item.Icon}
              tag={item.tone === "design" ? "Design" : item.tone === "product" ? "Product" : "Sales"}
              onOpen={() => go(item.to)}
              compact
              minHeight={110}
            />
