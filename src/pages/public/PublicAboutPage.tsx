  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ fontSize: 12, opacity: 0.7 }}>Capture â†’ Validate â†’ Select â†’ Output</div>
      </div>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 12, marginBottom: 18 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <div>
              ...
              <div style={{ fontSize: 12, opacity: 0.72 }}>About Â· Decision system Â· Tiered outputs</div>
            </div>
          </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1.1fr 0.9fr", gap: 16, alignItems: "start" }}>
          <div>
            <div style={{ fontSize: 12, letterSpacing: "0.14em", opacity: 0.75, marginBottom: 12 }}>
              WYRESTORM CAPABILITY LOGIC Â· INSTALL-AWARE VALIDATION Â· QUOTE-READY STRUCTURE
            </div>
          ...
          <div style={{ borderRadius: 18, border: "1px solid rgba(255,255,255,0.10)", background: "rgba(255,255,255,0.03)", padding: 16 }}>
            ...
            <div style={{ display: "grid", gap: 10 }}>
              {[
                ...
                { t: "Commercial proposal structure", d: "Cost-controlled â†’ recommended â†’ future-proof narrative." },
          ...
          <div style={{ borderRadius: 18, border: "1px solid rgba(255,255,255,0.10)", background: "rgba(255,255,255,0.03)", padding: 16 }}>
            ...
            <div style={{ display: "grid", gap: 10 }}>
              {[
                ...
                { t: "Underspecâ€™d performance", d: "Bandwidth/resolution mismatches flagged before quote." },
