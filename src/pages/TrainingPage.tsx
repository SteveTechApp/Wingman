...
const TrainingPage: React.FC = () => {
    ...
    const renderContent = () => {
        ...
        return (
            <div className="max-w-5xl mx-auto animate-fade-in-fast">
                {/* Page Header */}
                <div className="text-center mb-6">
                    <h1 className="text-3xl md:text-4xl font-extrabold text-accent mb-2 uppercase tracking-widest">Training Academy</h1>
                    <p className="text-lg text-text-secondary">Complete all modules to receive your certificate.</p>
                </div>
                ...
                <div className="bg-background-secondary border-2 border-border-color rounded-xl shadow-xl overflow-hidden">
                    ...
                    <div className="bg-accent text-white px-4 py-3">
                        <h2 className="text-lg font-bold uppercase tracking-wide">
                            Current Process: Select Training Module
                        </h2>
                    </div>

                    <div className="p-6">
                        <p className="text-sm text-text-secondary mb-6 text-center">
                            A score of 75% is required on each quiz to pass.
                        </p>
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {TRAINING_MODULES.map(module => (
                                <div key={module.id} className="p-6 bg-background rounded-xl border border-border-color flex flex-col justify-between shadow-sm hover:shadow-md transition-shadow duration-300 hover:border-accent">
                                    <div>
