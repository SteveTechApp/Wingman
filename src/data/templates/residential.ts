...
export const RESIDENTIAL_TEMPLATES: UserTemplate[] = [
    ...
    },
    {
        ...
        roomData: {
            ...
            manuallyAddedEquipment: [
                { sku: 'EX-40-H2-ARC', name: '4K60Hz 4.4.4 HDBaseT�?,???o�??s�?.�?f??s� Extender Set', quantity: 1, category: 'Extender', description: 'Dolby Vision & HDR | ARC | RS232 & 2-Way IR Passthrough (4K: 40m/115ft, 1080p: 70m/230ft)', tags: ['Extender', 'HDBaseT', 'ARC', 'Class B', '4K60', '4:4:4', 'HDR', 'RS232', 'IR'] },
            ],
