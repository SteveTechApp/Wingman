    ...
    <InfoModal isOpen={isOpen} onClose={onClose} title="Technology Specification Analyzer">
      <div className="space-y-6">
        ...
        <div className="bg-accent-bg-subtle\ border\ border-accent\ rounded-lg\ p-4">
          <h3 className="font-bold\ text-accent\ mb-2">�?,???o�??s��??z�?f??s� Cost Optimization Insight</h3>
          ...
          <p className="text-xs\ text-text-secondary\ mt-2">
            �?,???o�??s��??z�?f??s� Not every application needs 4K@60Hz 4:4:4. Match specs to actual requirements!
          </p>
        </div>
                    ...
                    >
                      <td className="p-2">
                        <div>
                          ...
                          {isCheapest && (
                            <span className="text-xs\ text-accent\ font-semibold">�?,???o�??s��??z�?f??s� Most Cost-Effective</span>
                          )}
                        </div>
                      </td>
                      <td className="p-2">
        ...
        <div className="bg-blue-50\ dark:bg-blue-900/20\ border\ border-blue-200\ dark:border-blue-800\ rounded-lg\ p-4">
          <h3 className="font-bold\ text-blue-900\ dark:text-blue-100\ mb-2">
            �?,???o�??s�?.??o?f???� Understanding Color Subsampling
          </h3>
