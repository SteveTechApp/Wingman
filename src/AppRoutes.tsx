    ...
    <React.Suspense fallback={<Loading />}>
      <Routes>
        ...
        >
          ...
          <Route path="tools/sales" element={<SalesPositioningPage />} />
          <Route path="tools/room-wizard" element={<RoomWizardPage />} />
          <Route path="tools/room-wizard/new" element={<RoomWizardPage />} />
          ...
          <Route path="tools/video-wall" element={<VideoWallPlannerRebuild />} />
          <Route path="tools/templates" element={<TemplatesPage />} />
          <Route
            path="tools/product-intelligence"
            element={
              <ProductIntelligenceAdminGate>
          ...
          <Route
            ...
            element={<CompetitorLookupDiagnosticsPage />}
          />
