  ...
  return (
    <PageShell>
      ...
      <div className="text-center\ mb-8\ flex-shrink-0">
        <h1 className="text-4xl\ font-semibold\ text-accent\ mb-2\ uppercase\ tracking-widest">Wingman AI Chat</h1>
        <p className="text-lg\ text-text-secondary">Ask technical questions or get product recommendations.</p>
      </div>

      <div className="wm-pill bg-background-secondary\ p-4\ rounded-xl\ shadow-xl\ border\ border-border-color\ flex-grow\ flex\ flex-col">
