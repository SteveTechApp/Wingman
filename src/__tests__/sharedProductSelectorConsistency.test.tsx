...
describe("shared product selector consistency", () => {
  ...
  it("keeps the primary selector consumers wired to the shared engine", () => {
    ...
    expect(readSource("src/wingman2/pages/RecommendationsPage.tsx")).toMatch(/features\/recommendations/);
    expect(readSource("src/wingman2/features/recommendations/application/buildRecommendation.ts")).toMatch(/recommendationsDecisionBoundary/);
