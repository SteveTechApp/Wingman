    ...
    >
      ...
      <SectionPane id="active" title="Active Opportunity">
        ...
        >
          ...
          >
            <span className="wm-mc__muted" style={{ color: "rgba(255,255,255,0.78)" }}>Selection</span>
            <span className="wm-mc__value" style={{ color: "rgba(255,255,255,0.96)", fontWeight: 600 }}>None selected</span>
          </div>
          <div
            className="wm-mc__row"
            style={{ display: "flex", justifyContent: "space-between", gap: 10, fontSize: 12 }}
          >
            <span className="wm-mc__muted" style={{ color: "rgba(255,255,255,0.78)" }}>Next action</span>
            <span className="wm-mc__value" style={{ color: "rgba(255,255,255,0.96)", fontWeight: 600 }}>Open Projects</span>
          </div>
        </div>
