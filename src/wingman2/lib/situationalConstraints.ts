...
const RULES: ConstraintRule[] = [
  // ---- Application (opportunity) shapes the whole job -----------------------
  {
    ...
    effects: {
      ...
      "uc-purpose": { recommend: ["video-conferencing", "conferencing-recording"], unlikely: ["no-uc"] },
      "uc-platform": { recommend: ["byom-user-laptop", "microsoft-teams-room", "room-pc-conferencing"] },
      "uc-camera": { recommend: ["fixed-usb-camera", "usb-ptz-camera"] },
      "uc-microphones": { recommend: ["speakerphone", "table-microphone", "ceiling-microphone-array"] },
      usb: { recommend: ["byod-byom", "room-pc-uc", "room-host-usb2"], unlikely: ["no-usb"] },
  ...
  },
  {
    ...
    effects: {
      ...
      "uc-purpose": { recommend: ["recording-streaming", "conferencing-recording", "video-conferencing"] },
      "uc-camera": { recommend: ["usb-ptz-camera", "ndi-network-camera"] },
      "uc-microphones": { recommend: ["lectern-microphone", "ceiling-microphone-array", "wireless-microphone"] },
      audio: { recommend: ["room-audio"] },
  ...
  },
  {
    ...
    effects: {
      ...
      "uc-purpose": { recommend: ["no-uc"], unlikely: ["video-conferencing"] },
  ...
  },
  {
    ...
    effects: {
      ...
      "uc-purpose": { recommend: ["camera-distribution-only", "no-uc"], unlikely: ["video-conferencing"] },
