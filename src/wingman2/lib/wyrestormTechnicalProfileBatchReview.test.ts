...
describe("WyreStorm technical profile batch governed review (2026-08)", () => {
  it("promoted the wireless and matrix compare leads to verified, compare-ready profiles", () => {
  ...
  it("completed the previously-held profiles to verified, compare-ready status", () => {
    const completed = [
      "EX-100-IW-USBC",
      "EX-60-USB2",
      "EXA-100-EARC",
  ...
  it("leaves the bare-SKU CX-30 intelligence lookup at family-rule tier without a fingerprint", () => {
    // The WyreStorm side of the headline compare scenario is a verified,
