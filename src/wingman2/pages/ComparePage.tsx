    ...
    <div className="pb-10">
      <PageHero
        ...
        actions={[
          ...
          { label: "Open sales helper", to: routeCatalogByKey.salesHelper.path, variant: "secondary" },
        ]}
      />
        ...
        <div className="grid gap-6 xl:grid-cols-[1.25fr_360px]">
            ...
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
              <div className="grid gap-3 md:grid-cols-[1fr_1fr_auto]">
                ...
                <Link
                  ...
                  className="rounded-2xl bg-slate-900 px-5 py-3 text-center text-sm font-medium text-white transition hover:bg-slate-800"
                >
                  Review positioning
                </Link>
              </div>
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
              ...
              <Link
                to={routeCatalogByKey.salesHelper.path}
                className="mt-4 inline-flex rounded-full border border-slate-300 px-4 py-2 text-sm text-slate-700 transition hover:bg-white"
              >
                Open sales helper
              </Link>
            </div>
