...
export const quickStartConfigs: Record<QuickStartRoomType, QuickStartConfig> = {
  "huddle-room": {
    ...
    defaults: {
      ...
      "display-behaviour": "mirrored-outputs",
      "signal-standard": "hdmi-only",
      "uc-purpose": ["video-conferencing"],
      "uc-platform": ["microsoft-teams-room"],
      "uc-camera": ["fixed-usb-camera"],
      "uc-microphones": ["speakerphone"],
      usb: "table-usb-c-input",
      audio: "integrated-device-audio",
      control: "simple-room-control",
    },
  },
  "meeting-room-small": {
    ...
    defaults: {
      ...
      "uc-microphones": ["ceiling-microphone"],
      usb: "table-usb-c-input",
      audio: "room-speakers-and-amplifier",
      control: "touch-panel-control",
    },
  },
  "meeting-room-large": {
    ...
    defaults: {
      ...
      displays: "two-displays",
      "display-behaviour": "independent-routing-per-display",
      "signal-standard": "premium-4k60",
      "uc-purpose": ["video-conferencing"],
      "uc-platform": ["microsoft-teams-room"],
      "uc-camera": ["usb-ptz-camera"],
      "uc-microphones": ["ceiling-microphone", "table-microphone"],
      usb: "distributed-usb-extender",
      audio: "room-speakers-and-amplifier",
      control: "touch-panel-control",
    },
  },
