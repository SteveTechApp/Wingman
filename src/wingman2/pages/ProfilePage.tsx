      ...
      <section className="wm-profile-grid">
        ...
        <article className="wm-profile-card">
          ...
          <span className="wm-profile-note">
            Overall language controls the Wingman preference. Capture language controls browser speech recognition during customer feedback capture.
          </span>
        </article>
